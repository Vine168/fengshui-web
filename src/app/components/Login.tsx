    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to access the MASTER PISETH Dashboard</p>
        </div>
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button 
                  type="button" 
                  onClick={(e) => { e.preventDefault(); toast.info("Password recovery is currently disabled."); }}
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground">
              By signing in, you agree to our <button type="button" onClick={(e) => { e.preventDefault(); toast.info("Legal documents coming soon."); }} className="text-primary hover:underline text-[13px]">Terms of Service</button> and <button type="button" onClick={(e) => { e.preventDefault(); toast.info("Legal documents coming soon."); }} className="text-primary hover:underline text-[13px]">Privacy Policy</button>.
            </p>
          </div>
        </div>
      </Motion.div>
