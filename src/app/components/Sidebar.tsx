      ...
      <div
        className={clsx(
          ...
          isCollapsed && !isMobile
            ? "p-[15px] justify-center"
            : "p-[15px] gap-3 justify-center",
        )}
      >
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          {(!isCollapsed || isMobile) && (
            <div className="min-w-0">
              ...
              <p className="text-xs text-sidebar-foreground/60 uppercase tracking-widest truncate">
                Admin Panel v1.0.1
              </p>
            </div>
          )}
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <item.icon
                          className={clsx(
                            ...
                            isActive
                              ...
                              : "group-hover:text-sidebar-primary/80 transition-colors",
                          )}
                        />
                        ...
                        {(!isCollapsed || isMobile) && (
                          <span
                            className={clsx(
                              "font-medium relative z-10 whitespace-nowrap flex-1 text-left",
        ...
        <div className="p-4 border-t border-sidebar-border mt-auto transition-all duration-300 flex justify-center">
          <button
            ...
            className={clsx(
              ...
              isCollapsed
                ? "p-2 gap-0 justify-center"
                : "w-full px-4 py-3 gap-3 justify-center",
            )}
          ...
          >
            ...
            <span
              className={clsx(
                "whitespace-nowrap text-[15px] font-medium transition-all duration-300 overflow-hidden",
